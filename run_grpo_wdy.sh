...
export PROJECT_NAME='hotpotqa_qwen2.5-3b-instruct_ys'
export EXPERIMENT_NAME=grpo_baai_corpus_wiki_no_kl
export HYDRA_FULL_ERROR=1
export CUDA_VISIBLE_DEVICES=4,5,6,7
export CUDA_LAUNCH_BLOCKING=1export 
# WANDB_API_KEY="9149bb421b40127105958afc4adc29d44a887a2b"
