...
export PROJECT_NAME='math_dapo_qwen2.5-3b-instruct_ys'
export EXPERIMENT_NAME=grpo_math_dapo
...
python3 -m agent_r1.src.main_agent \
    ...
    data.train_files=./data/math_dapo/train.parquet \
    data.val_files=./data/math_dapo/test.parquet \
